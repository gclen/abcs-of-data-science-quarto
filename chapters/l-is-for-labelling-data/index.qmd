...
# L is for Labelling Data {#sec-l-is-for-labelling-data}
...
Instead of labelling each point individually, you can often try clustering (@sec-c-is-for-clustering) your data beforehand. This allows you to label groups of data instead of each individual point. 
