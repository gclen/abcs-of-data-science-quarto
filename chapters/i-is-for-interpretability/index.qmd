...
# I is for Interpretability {#sec-i-is-for-interpretability}

Machine learning models are increasingly used to make decisions in everyday life, and as we’ve discussed before (see @sec-b-is-for-bias), they can be 
far from perfect. In addition to being able to appeal the decisions made by a model, 
