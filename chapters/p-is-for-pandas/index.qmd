...
# P is for Pandas {#sec-p-is-for-pandas}

[Pandas](https://pandas.pydata.org/docs/index.html) is a very popular data analysis library for python. It’s an invaluable tool for transforming and munging data (@sec-m-is-for-munging-data). Some of my favourite features include:
