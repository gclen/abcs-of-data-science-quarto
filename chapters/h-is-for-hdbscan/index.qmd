...
# H is for HDBSCAN {#sec-h-is-for-hdbscan}

There are many data science problems where you don’t have labelled data and need to use clustering (@sec-c-is-for-clustering) to find related points. For these clustering problems, HDBSCAN is a great algorithm. It was originally created by [Campello et al.](https://link.springer.com/chapter/10.1007/978-3-642-37456-2_14) and there is a [fast Python implementation](https://github.com/scikit-learn-contrib/hdbscan) written by [Leland Mcinnes](https://twitter.com/leland_mcinnes?lang=en) and [John Healy](https://github.com/jc-healy). When I refer to HDBSCAN I’ll be talking about the python implementation/package. It is generally the first clustering method I try for a variety of reasons:
...
The first thing we need is an embedding (@sec-e-is-for-embeddings), which as you might recall is just a numeric representation of your data with a way to measure distance between points.
