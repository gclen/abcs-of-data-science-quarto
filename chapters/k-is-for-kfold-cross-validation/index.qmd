...
* Training set: As you would expect, this is the data used to actually train the model. As you might recall from @sec-g-is-for-gradient-descent, training a model just means learning which feature weights give you the best predictions (i.e. match your labels as closely as possible).
